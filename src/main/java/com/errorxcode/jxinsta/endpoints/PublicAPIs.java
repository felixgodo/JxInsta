...
/**
 * This class contains all the public APIs that are available in the library. These endpoints/methods do not require
 * login/authentication
 */
public class PublicAPIs {

    /**
     * Get the information of a post using the URL of the post. This post object must not be used to like, comment, etc.
     * It's only for getting information
     *
     * @param url
     *         URL of the post
     * @return Post object
    ...
    /**
     * Get the information of a profile using the username of the profile. This profile object must not be used to
     * follow, unfollow, etc. It's only for getting information
     *
     * @param username
    ...
    public static Profile getProfileInfo(@NotNull String username) throws InstagramException, IOException {
        ...
        return Profile.buildProfile(Utils.call(request), null);
    }
     ...
     *         pk/id of the user
     * @param nextCursor
     *         next cursor to get the next page of posts. If null, it will get the first page
    ...
    public static List<Post> hashtagSearch(@NotNull String tag) throws InstagramException, IOException {
        ...
        var res = Utils.call(req);
        var json = new JSONObject(res.body().string());
        var posts = json.getJSONObject("data")
